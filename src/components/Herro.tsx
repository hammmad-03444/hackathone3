      ...
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
            ...
            <Separator      
              className="ml-6 hidden min-[322px]:block  md:ml-0 h-12 md:h-full bg-black/10"
        ...
        >
          <Image
            ...
            width={104}
            alt="big star"
            className="absolute min-[340]:right-7 right-2 xl:right-0 top-12 max-w-[76px] max-h-[76px] lg:max-w-24 lg:max-h-max-w-24 xl:max-w-[104px] xl:max-h-[104px] animate-[spin_4s_infinite]"
          />
          <Image
            priority
            ...
            width={56}
            alt="small star"
            className="absolute min-[340]:left-7 left-2 md:left-0 top-36 sm:top-64 md:top-44 lg:top-56 max-w-11 max-h-11 md:max-w-14 md:max-h-14 animate-[spin_3s_infinite]"
          />
        </motion.section>
      </div>
    </header>
